            ...
            <section className="div-1 about">
              ...
              <div>
                <p className="text mt-4 mb-3">
                  ...
                  problems (
                  <span style={{ color: "#24d6f1" }}>arrhythmias</span>
                  ); and heart defects you're born with (
                  <span style={{ color: "#24d6f1" }}>
                ...
                <p className="text my-3">
                  ...
                  the term "cardiovascular disease." Cardiovascular disease
                  generally refers to conditions that involve narrowed or
                  blocked blood vessels that can lead to a heart attack, chest
                  pain (<span style={{ color: "#24d6f1" }}>angina</span>) or
                  stroke. Other heart conditions, such as those that affect your
                  heart's muscle, valves or rhythm, also are considered forms of
                  heart disease.
                </p>
              </div>
            </section>
            <section className="div-1 about mt-5">
              ...
              <div>
                <p className="text mt-4 mb-3">
                  ...
                  or chest pain. Angina can be described as a discomfort,
                  heaviness, pressure, aching, burning, fullness, squeezing, or
                  painful feeling in your chest. It can be mistaken for
                  indigestion or heartburn. Angina may also be felt in the
